...
object ChaChaModel {
    ...
    /**
      * Joins a seq of 32b Ints to a single BigInt.
      *
      * @param mat
      * @return
      */
    def wordsToBigInt(mat: Seq[BigInt]): BigInt = {
      var sum = BigInt(0)
...
/**
  * Chisel implementation of the ChaCha stream cipher. The module will
  * keep reading input until valid goes low. Then for 20 cycles, the
  * module will alternate btwn 4 column rounds and 4 diag rounds. The 
  * final keyStream is the concatenation of the 16, 32b UInts = 512b.
  */
